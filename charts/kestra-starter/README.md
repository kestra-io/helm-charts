...
![Version: 1.1.9](https://img.shields.io/badge/Version-1.1.9-informational?style=flat-square) ![AppVersion: v1.3.0](https://img.shields.io/badge/AppVersion-v1.3.0-informational?style=flat-square)
...
$ helm install my-kestra-starter kestra/kestra-starter --version 1.1.9
```
...
| https://helm.kestra.io/ | kestra | 1.0.39 |
